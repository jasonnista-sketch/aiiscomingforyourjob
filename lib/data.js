export const INDUSTRIES = [
  {
    ...
    jobs: [
      ...
      { id: "home-health-aide", title: "Home Health Aide", risk: 12, augment: 45,
        ...
        skills: ["Using remote patient monitoring devices", "AI-assisted care documentation", "Smart home health technology", "Digital vitals tracking and reporting"],
        resources: [
      ...
      { id: "nursing-assistant", title: "Nursing Assistant (CNA)", risk: 14, augment: 48,
        ...
        skills: ["Digital vital signs documentation", "AI-powered fall prevention systems", "Remote patient monitoring basics", "Electronic health record navigation"],
        resources: [
      ...
      { id: "medical-assistant", title: "Medical Assistant", risk: 35, augment: 72,
        ...
        skills: ["AI-assisted patient intake workflows", "Digital pre-visit planning tools", "Automated appointment scheduling systems", "EHR optimization and clinical documentation"],
        resources: [
      ...
      { id: "healthcare-administrator", title: "Healthcare Administrator", risk: 32, augment: 78,
        ...
        skills: ["AI-driven operational analytics", "Predictive staffing and demand forecasting", "Automated compliance monitoring", "Data-driven quality improvement initiatives"],
        resources: [
      ...
      { id: "therapist", title: "Therapist / Mental Health Counselor", risk: 10, augment: 62,
        ...
        skills: ["Integrating AI-assisted outcome tracking", "Using digital between-session support tools", "AI-powered treatment planning assistance", "Telehealth platform proficiency"],
        resources: [
      ...
      { id: "pharmacist", title: "Pharmacist", risk: 52, augment: 80,
        ...
        skills: ["Clinical medication therapy management", "AI drug interaction analysis workflows", "Automated dispensing system oversight", "Patient medication counseling and education"],
        resources: [
      ...
      { id: "nurse-practitioner", title: "Nurse Practitioner", risk: 18, augment: 82,
        ...
        skills: ["AI-assisted clinical decision-making", "Ambient documentation workflows", "Telehealth diagnosis and treatment", "AI differential diagnosis validation"],
        resources: [
      ...
      { id: "physical-therapist", title: "Physical Therapist", risk: 8, augment: 52,
        ...
        skills: ["Prescribing AI-guided home exercise programs", "Remote patient monitoring interpretation", "Digital movement analysis tools", "Telehealth physical therapy delivery"],
        resources: [
      ...
      { id: "physician-assistant", title: "Physician Assistant", risk: 20, augment: 80,
        ...
        skills: ["AI-assisted diagnostic reasoning", "Ambient clinical documentation workflows", "Point-of-care AI reference tools", "AI-flagged drug interaction management"],
        resources: [
      ...
      { id: "dentist", title: "Dentist", risk: 15, augment: 65,
        ...
        skills: ["AI-assisted radiograph interpretation", "Digital treatment planning with AI support", "CAD/CAM digital dentistry workflows", "AI-powered patient communication tools"],
        resources: [
          { title: "ADA — American Dental Association Technology Resources", url: "https://www.ada.org" },
        ]},
      { id: "primary-care-doctor", title: "Primary Care Doctor", risk: 25, augment: 82,
        summary: "AI transforms primary care by automating clinical documentation, suggesting diagnoses, flagging drug interactions, and predicting patient deterioration. But the doctor-patient relationship, complex clinical reasoning, and the art of medicine remain human.",
        ...
        skills: ["Ambient clinical documentation workflows", "AI-assisted differential diagnosis validation", "Predictive risk score interpretation", "AI-flagged care gap management"],
        resources: [
      ...
      { id: "surgeon", title: "Surgeon", risk: 10, augment: 72,
        ...
        skills: ["Robotic-assisted surgical techniques", "AI-powered pre-operative planning", "3D visualization and surgical simulation", "Data-driven post-operative risk management"],
        resources: [
      ...
      { id: "emergency-room-doctor", title: "Emergency Room Doctor", risk: 12, augment: 75,
        ...
        skills: ["AI-assisted rapid triage interpretation", "Real-time AI imaging analysis workflows", "Predictive deterioration alert management", "AI-enhanced mass casualty triage protocols"],
        resources: [
      ...
      { id: "anesthesiologist", title: "Anesthesiologist", risk: 28, augment: 82,
        ...
        skills: ["AI-predicted hemodynamic management", "Depth-of-anesthesia AI monitoring interpretation", "Real-time AI blood loss estimation workflows", "Predictive complication alert management"],
        resources: [
          { title: "ASA — American Society of Anesthesiologists", url: "https://www.asahq.org" },
        ]},
      { id: "psychiatrist", title: "Psychiatrist", risk: 15, augment: 68,
        summary: "Psychiatry requires deep empathy, nuanced conversation, and understanding of the human condition that AI cannot replicate. AI aids with screening assessments, medication management alerts, and pattern recognition in patient progress — but prescribing decisions and therapy are human.",
        keyInsight: "The mental health crisis has created a massive psychiatrist shortage. AI extends each psychiatrist's reach without replacing the therapeutic relationship.",
        tools: [
        ...
        skills: ["AI-assisted psychiatric assessment tools", "Digital outcome measurement integration", "Telepsychiatry platform proficiency", "AI-flagged medication interaction management"],
        resources: [
