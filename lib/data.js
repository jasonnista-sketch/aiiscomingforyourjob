  ...
  },
  {
    ...
    jobs: [
      ...
      { id: "bookkeeper", title: "Bookkeeper", risk: 82, augment: 50,
        summary: "AI handles transaction categorization, bank reconciliation, and invoice processing with near-perfect accuracy. Bookkeepers who don't upskill face the highest displacement risk in finance.",
        keyInsight: "QuickBooks and Xero now auto-categorize over 90% of transactions. The manual data-entry bookkeeper role is vanishing fast.",
        tools: [
          { name: "QuickBooks AI", url: "https://quickbooks.intuit.com", desc: "AI-powered small business accounting" },
          { name: "Xero", url: "https://www.xero.com", desc: "Cloud accounting with AI bank feeds" },
          { name: "Dext", url: "https://dext.com", desc: "AI receipt and invoice data capture" },
          { name: "Hubdoc", url: "https://www.hubdoc.com", desc: "Automated document collection and publishing" },
        ],
        skills: ["Cloud accounting platform mastery", "AI-driven reconciliation workflows", "Advisory services for small business", "Data quality management"],
        resources: [
      ...
      { id: "tax-preparer", title: "Tax Preparer", risk: 72, augment: 60,
        summary: "AI tax software handles standard returns end-to-end. Complex multi-entity, cross-border, and estate tax planning still demands human expertise and judgment.",
        keyInsight: "TurboTax and H&R Block's AI can now handle 80% of individual returns without human intervention. The remaining 20% is where the real value lives.",
        tools: [
          { name: "TurboTax AI", url: "https://turbotax.intuit.com", desc: "AI-guided consumer tax preparation" },
          { name: "Thomson Reuters ONESOURCE", url: "https://tax.thomsonreuters.com", desc: "AI-powered corporate tax platform" },
          { name: "Blue Dot", url: "https://www.bluedotcorp.com", desc: "AI tax compliance and reporting" },
          { name: "Avalara", url: "https://www.avalara.com", desc: "Automated tax compliance for businesses" },
        ],
        skills: ["Complex tax scenario planning", "Cross-border tax expertise", "AI tool configuration and review", "Client advisory and tax strategy"],
        resources: [
      ...
      { id: "auditor", title: "Auditor", risk: 38, augment: 88,
        summary: "AI transforms audit from sampling to full-population analysis. Auditors gain superhuman pattern detection while retaining irreplaceable professional judgment and skepticism.",
        keyInsight: "AI can analyze 100% of transactions instead of samples. Auditors who leverage this deliver dramatically more value than those stuck in traditional methods.",
        tools: [
          { name: "MindBridge", url: "https://www.mindbridge.ai", desc: "AI-powered audit analytics and anomaly detection" },
          { name: "CaseWare IDEA", url: "https://www.caseware.com", desc: "Data analytics for audit professionals" },
          { name: "Diligent", url: "https://www.diligent.com", desc: "AI-powered audit management platform" },
          { name: "AuditBoard", url: "https://www.auditboard.com", desc: "Connected risk management and audit platform" },
        ],
        skills: ["AI-augmented audit methodology", "Data analytics for full-population testing", "Continuous auditing techniques", "Fraud detection with machine learning"],
        resources: [
      ...
      { id: "investment-banker", title: "Investment Banker", risk: 30, augment: 90,
        summary: "AI accelerates deal sourcing, due diligence, and financial modeling. Relationship management, negotiation, and strategic judgment keep humans essential at the top.",
        keyInsight: "Junior banker tasks (building pitch books, comps, models) are being automated. The survivors will be those who combine AI speed with human deal instincts.",
        tools: [
          { name: "Dealogic", url: "https://www.dealogic.com", desc: "AI-powered investment banking analytics" },
          { name: "Tegus", url: "https://www.tegus.com", desc: "AI-driven expert network and research platform" },
          { name: "Visible Alpha", url: "https://visiblealpha.com", desc: "AI-powered consensus and estimate analytics" },
          { name: "Sourcescrub", url: "https://www.sourcescrub.com", desc: "AI deal sourcing for private markets" },
        ],
        skills: ["AI-assisted valuation modeling", "Machine learning for deal screening", "Automated due diligence workflows", "Strategic relationship management"],
        resources: [
      ...
      { id: "compliance-officer-finance", title: "Compliance Officer (Finance)", risk: 35, augment: 85,
        summary: "AI monitors transactions for regulatory violations in real-time across millions of data points. Compliance officers shift from manual checking to strategic risk management and policy interpretation.",
        keyInsight: "RegTech AI reduces false positives by up to 70%, freeing compliance teams to focus on genuine risks instead of drowning in alerts.",
        tools: [
          { name: "ComplyAdvantage", url: "https://complyadvantage.com", desc: "AI-driven financial crime detection" },
          { name: "Chainalysis", url: "https://www.chainalysis.com", desc: "Blockchain analytics and crypto compliance" },
          { name: "Hummingbird", url: "https://hummingbird.co", desc: "AI-powered BSA/AML compliance" },
          { name: "Ascent RegTech", url: "https://www.ascentregtech.com", desc: "AI regulatory change management" },
        ],
        skills: ["AI-powered transaction monitoring", "RegTech platform management", "Risk-based compliance frameworks", "Regulatory change automation"],
        resources: [
      ...
      { id: "financial-planner", title: "Financial Planner / Advisor", risk: 35, augment: 80,
        summary: "Robo-advisors handle basic portfolio allocation and rebalancing. Human advisors thrive in complex life planning, behavioral coaching, and high-net-worth relationship management.",
        ...
        tools: [
          { name: "RightCapital", url: "https://www.rightcapital.com", desc: "AI-powered financial planning software" },
          { name: "MoneyGuidePro", url: "https://www.moneyguidepro.com", desc: "Goal-based financial planning platform" },
          { name: "Holistiplan", url: "https://holistiplan.com", desc: "AI-driven tax planning for advisors" },
          { name: "Orion", url: "https://www.orion.com", desc: "AI portfolio management and analytics" },
        ],
        skills: ["AI-augmented financial planning", "Behavioral finance coaching", "Tax-efficient portfolio strategy", "Complex estate and retirement planning"],
        resources: [
      ...
      { id: "loan-officer", title: "Loan Officer / Underwriter", risk: 65, augment: 65,
        summary: "AI credit scoring and automated underwriting handle standard loan decisions in seconds. Complex commercial lending and relationship-based decisions still need human judgment.",
        keyInsight: "AI underwriting processes mortgage applications 10x faster than humans. Loan officers must evolve from processors to advisors or face displacement.",
        tools: [
          { name: "Zest AI", url: "https://www.zest.ai", desc: "AI-powered credit underwriting" },
          { name: "Upstart", url: "https://www.upstart.com", desc: "AI lending platform" },
          { name: "Blend", url: "https://blend.com", desc: "AI-powered mortgage and lending platform" },
          { name: "Ocrolus", url: "https://www.ocrolus.com", desc: "AI document analysis for lending" },
        ],
        skills: ["AI credit model interpretation", "Complex commercial loan structuring", "Regulatory compliance in automated lending", "Client advisory for non-standard scenarios"],
        resources: [
      ...
      { id: "trader", title: "Trader / Quantitative Analyst", risk: 55, augment: 88,
        summary: "Algorithmic and high-frequency trading are fully AI-driven. Discretionary traders survive by finding edges in illiquid markets, complex derivatives, and human-sentiment-driven events.",
        ...
        tools: [
          { name: "QuantConnect", url: "https://www.quantconnect.com", desc: "Open-source algorithmic trading platform" },
          { name: "Alpaca", url: "https://alpaca.markets", desc: "API-first trading platform for algo strategies" },
          { name: "Refinitiv (LSEG)", url: "https://www.lseg.com/en/data-analytics", desc: "AI-powered market data and analytics" },
          { name: "Numerai", url: "https://numer.ai", desc: "AI-powered crowdsourced hedge fund" },
        ],
        skills: ["Machine learning model development", "Alternative data analysis", "Algorithmic strategy backtesting", "Risk management with AI tools"],
        resources: [
  ...
  },
  {
    ...
    jobs: [
      ...
      { id: "social-media-manager", title: "Social Media Manager", risk: 52, augment: 88,
        summary: "AI generates posts, schedules content, analyzes engagement, and even responds to comments. But brand voice, community building, and crisis management still need humans.",
        keyInsight: "AI can post for you. It can't be you. Authenticity and real-time cultural awareness are the moat.",
        tools: [
          { name: "Sprout Social", url: "https://sproutsocial.com", desc: "AI-powered social media management and analytics" },
          { name: "Hootsuite", url: "https://www.hootsuite.com", desc: "AI scheduling, analytics, and content suggestions" },
          { name: "Lately", url: "https://www.lately.ai", desc: "AI that repurposes long-form content into social posts" },
          { name: "Brandwatch", url: "https://www.brandwatch.com", desc: "AI social listening and consumer intelligence" },
        ],
        skills: ["AI content generation and curation", "Social listening with AI analytics", "AI-optimized posting schedules", "Community management strategy"],
        resources: [
      ...
      { id: "seo-specialist", title: "SEO Specialist", risk: 58, augment: 90,
        summary: "AI generates optimized content, automates technical audits, and predicts ranking changes. SEO specialists must shift from keyword stuffing to strategic content architecture.",
        keyInsight: "Google's AI-generated search results are changing the game. SEO now means optimizing for AI summaries, not just blue links.",
        tools: [
          { name: "Surfer SEO", url: "https://surferseo.com", desc: "AI-powered content optimization and SERP analysis" },
          { name: "Clearscope", url: "https://www.clearscope.io", desc: "AI content optimization for search" },
          { name: "Semrush", url: "https://www.semrush.com", desc: "AI-enhanced SEO and marketing platform" },
          { name: "Frase", url: "https://www.frase.io", desc: "AI content briefs and optimization" },
        ],
        skills: ["AI content optimization workflows", "Technical SEO automation", "AI search result optimization", "Programmatic SEO at scale"],
        resources: [
      ...
      { id: "photographer", title: "Photographer", risk: 40, augment: 78,
        summary: "AI generates photorealistic images and enhances real photos dramatically. But capturing authentic moments, directing shoots, and building client relationships remain human.",
        keyInsight: "Stock photography is being decimated by AI generation. Commercial and editorial photographers survive by offering what AI can't: real moments and real trust.",
        tools: [
          { name: "Adobe Lightroom AI", url: "https://www.adobe.com/products/photoshop-lightroom.html", desc: "AI masking, editing, and enhancement" },
          { name: "Topaz Photo AI", url: "https://www.topazlabs.com/topaz-photo-ai", desc: "AI noise reduction, sharpening, and upscaling" },
          { name: "Imagen AI", url: "https://www.imagen-ai.com", desc: "AI photo editing assistant for photographers" },
          { name: "Narrative Select", url: "https://narrative.so", desc: "AI-powered photo culling for events" },
        ],
        skills: ["AI-powered batch editing workflows", "AI-assisted culling and selection", "Hybrid AI-real image compositing", "Prompt engineering for reference images"],
        resources: [
      ...
      { id: "musician-audio", title: "Musician / Audio Producer", risk: 45, augment: 82,
        summary: "AI composes background music, masters tracks, and generates sound effects. But artistic vision, live performance, and emotional expression remain irreplaceably human.",
        keyInsight: "AI music is flooding streaming platforms with 'functional' content. Human artists win by creating work with genuine emotional depth and cultural meaning.",
        tools: [
          { name: "LANDR", url: "https://www.landr.com", desc: "AI mastering and distribution platform" },
          { name: "Udio", url: "https://www.udio.com", desc: "AI music generation from text prompts" },
          { name: "iZotope", url: "https://www.izotope.com", desc: "AI-powered audio mixing and mastering" },
          { name: "Splice", url: "https://splice.com", desc: "AI-assisted sample discovery and beat creation" },
        ],
        skills: ["AI-assisted production workflows", "AI mastering and mixing tools", "Prompt engineering for sound design", "Hybrid human-AI composition"],
        resources: [
      ...
      { id: "marketing-manager", title: "Marketing Manager / CMO", risk: 25, augment: 88,
        summary: "AI automates campaign optimization, audience targeting, and performance analytics. Strategic brand building, creative direction, and cross-functional leadership stay human.",
        keyInsight: "CMOs who master AI tools can run campaigns that used to require 10-person teams. The strategic layer is the last to be automated.",
        tools: [
          { name: "HubSpot AI", url: "https://www.hubspot.com", desc: "AI-powered marketing automation and CRM" },
          { name: "Albert AI", url: "https://albert.ai", desc: "Autonomous AI marketing platform" },
          { name: "Persado", url: "https://www.persado.com", desc: "AI-generated marketing language optimization" },
          { name: "6sense", url: "https://6sense.com", desc: "AI-powered account-based marketing" },
        ],
        skills: ["AI campaign optimization", "Marketing attribution with AI", "AI-driven customer segmentation", "Strategic brand building in the AI era"],
        resources: [
          { title: "MarTech — AI Marketing Coverage", url: "https://martech.org" },
        ]},
      { id: "ux-designer", title: "UX/UI Designer", risk: 35, augment: 90,
        summary: "AI generates wireframes, prototypes, and even full interfaces from prompts. But understanding user needs, conducting research, and designing for complex human behavior remain human.",
        keyInsight: "AI can generate a UI. It can't understand why a user is frustrated. Empathy-driven design is the enduring differentiator.",
        tools: [
          { name: "Figma AI", url: "https://www.figma.com", desc: "AI-powered design and prototyping" },
          { name: "Galileo AI", url: "https://www.usegalileo.ai", desc: "AI UI design generation from text" },
          { name: "Uizard", url: "https://uizard.io", desc: "AI wireframe and mockup generation" },
          { name: "Maze", url: "https://maze.co", desc: "AI-powered user testing and research" },
        ],
        skills: ["AI-generated prototyping", "AI user research synthesis", "Design system management with AI", "Accessibility testing with AI tools"],
        resources: [
  ...
  },
  {
    ...
    jobs: [
      ...
      { id: "cybersecurity-analyst", title: "Cybersecurity Analyst", risk: 18, augment: 92,
        summary: "AI detects threats in real-time across millions of events, but adversaries also use AI. The cat-and-mouse game ensures human analysts remain critical for novel attacks and strategic defense.",
        keyInsight: "AI handles 95% of threat alerts. The 5% that slip through are the ones that matter most — and they need human creativity to catch.",
        tools: [
          { name: "CrowdStrike Falcon", url: "https://www.crowdstrike.com", desc: "AI-powered endpoint detection and response" },
          { name: "Darktrace", url: "https://darktrace.com", desc: "Self-learning AI cybersecurity platform" },
          { name: "SentinelOne", url: "https://www.sentinelone.com", desc: "AI-powered autonomous security" },
          { name: "Splunk", url: "https://www.splunk.com", desc: "AI-driven security information and event management" },
        ],
        skills: ["AI threat detection and response", "Machine learning for anomaly detection", "Adversarial AI awareness", "Automated incident response workflows"],
        resources: [
      ...
      { id: "devops-engineer", title: "DevOps / SRE Engineer", risk: 32, augment: 90,
        summary: "AI automates deployments, monitors systems, and predicts outages. But designing resilient architectures and handling novel incidents still require human judgment.",
        keyInsight: "AI can auto-remediate known issues. Unknown unknowns — the cascading failures that take down systems — still need humans who understand the full stack.",
        tools: [
          { name: "PagerDuty AIOps", url: "https://www.pagerduty.com", desc: "AI incident management and response" },
          { name: "Datadog", url: "https://www.datadoghq.com", desc: "AI-powered observability and monitoring" },
          { name: "Harness", url: "https://www.harness.io", desc: "AI-driven continuous delivery and deployment" },
          { name: "Kubiya", url: "https://www.kubiya.ai", desc: "AI assistant for DevOps workflows" },
        ],
        skills: ["AI-powered observability", "Automated incident remediation", "Infrastructure as code with AI", "AIOps platform management"],
        resources: [
      ...
      { id: "qa-engineer", title: "QA / Test Engineer", risk: 48, augment: 88,
        summary: "AI generates test cases, maintains test suites, and finds bugs through pattern recognition. QA engineers shift from writing tests to designing testing strategies.",
        keyInsight: "AI can write and run 10x more tests than a human. QA engineers who direct that power are invaluable; those who only write tests manually are at risk.",
        tools: [
          { name: "Testim", url: "https://www.testim.io", desc: "AI-powered test automation" },
          { name: "Mabl", url: "https://www.mabl.com", desc: "AI-native test automation platform" },
          { name: "Applitools", url: "https://applitools.com", desc: "AI visual testing and monitoring" },
          { name: "Katalon", url: "https://katalon.com", desc: "AI-augmented test orchestration" },
        ],
        skills: ["AI test generation and maintenance", "Visual regression testing with AI", "Test strategy and architecture", "AI-driven performance testing"],
        resources: [
      ...
      { id: "it-support", title: "IT Support / Help Desk", risk: 68, augment: 70,
        summary: "AI chatbots resolve most Tier 1 support tickets automatically. IT support professionals must move up the complexity ladder to survive.",
        keyInsight: "AI resolves 60-80% of routine IT tickets without human intervention. The remaining complex issues require deeper technical skills than ever.",
        tools: [
          { name: "Freshservice AI", url: "https://www.freshworks.com/freshservice/", desc: "AI-powered IT service management" },
          { name: "ServiceNow", url: "https://www.servicenow.com", desc: "AI-driven IT service management and automation" },
          { name: "Moveworks", url: "https://www.moveworks.com", desc: "AI employee support automation" },
        ],
        skills: ["AI chatbot configuration and training", "Complex troubleshooting beyond AI capability", "IT automation and orchestration", "User experience for AI-assisted support"],
        resources: [
          { title: "HDI — AI in Service Management", url: "https://www.thinkhdi.com" },
        ]},
      { id: "cloud-architect", title: "Cloud Architect", risk: 20, augment: 88,
        summary: "AI optimizes cloud costs, auto-scales infrastructure, and suggests architectures. But designing for complex requirements, compliance, and multi-cloud strategy needs human architects.",
        keyInsight: "AI can optimize what exists. Designing what should exist — balancing cost, performance, security, and compliance — is a deeply human skill.",
        tools: [
          { name: "AWS AI Services", url: "https://aws.amazon.com/ai/", desc: "AI-powered cloud optimization and services" },
          { name: "Spot by NetApp", url: "https://spot.io", desc: "AI-driven cloud infrastructure optimization" },
          { name: "Pulumi AI", url: "https://www.pulumi.com", desc: "AI-assisted infrastructure as code" },
          { name: "Cast AI", url: "https://cast.ai", desc: "AI Kubernetes cost optimization" },
        ],
        skills: ["AI-optimized cloud architecture", "FinOps with AI cost management", "AI-driven auto-scaling strategies", "Multi-cloud AI service integration"],
        resources: [
      ...
      { id: "database-admin", title: "Database Administrator", risk: 55, augment: 82,
        summary: "AI automates query optimization, performance tuning, and routine maintenance. DBAs who don't evolve into data platform engineers face displacement.",
        keyInsight: "Cloud-managed databases with AI tuning handle 80% of what traditional DBAs did. The survivors specialize in complex architectures and data strategy.",
        tools: [
          { name: "OtterTune", url: "https://ottertune.com", desc: "AI-powered database optimization" },
          { name: "EverSQL", url: "https://www.eversql.com", desc: "AI SQL query optimization" },
          { name: "Percona", url: "https://www.percona.com", desc: "Open-source database tools with AI monitoring" },
        ],
        skills: ["AI-powered query optimization", "Cloud-native database management", "Data platform architecture", "Automated performance tuning"],
        resources: [
