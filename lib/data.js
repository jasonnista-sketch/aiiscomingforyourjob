...
{ id: "nurse", title: "Registered Nurse", risk: 15, augment: 72,
  ...
  },
  {
    ...
    jobs: [
      ...
      { id: "carpenter", title: "Carpenter", risk: 7, augment: 38,
        summary: "No — carpentry is one of the most AI-resistant careers in existence. Every project is different: different structures, different materials, different site conditions. AI helps with design, estimating, and project planning, but the physical craft of measuring, cutting, fitting, and building in unpredictable environments is decades away from automation.",
        keyInsight: "The construction industry needs 500,000+ new workers by 2030, and the average carpenter is over 50. AI isn't threatening carpentry — it's making the shortage worse as construction demand grows while the workforce shrinks.",
        aiChanging: "AI-powered design tools generate construction plans and material lists from 3D models. Estimating software produces accurate bids from blueprints. Drones and laser scanners capture site conditions digitally. But none of this changes the fundamental reality: someone still needs to frame the wall, hang the door, and finish the trim.",
        blsStats: { medianSalary: "$56,350", totalJobs: "786,000", growth: "+2%", growthLabel: "Stable" },
        aiCapability: {
          mastered: [
            { title: "Design modeling and material takeoffs", desc: "AI generates detailed 3D construction models, calculates precise material quantities from plans, and produces cut lists automatically — eliminating hours of manual takeoff work and reducing material waste by 10-15%." },
            { title: "Estimating and bid generation", desc: "AI-powered estimating tools analyze blueprints, calculate labor and material costs, and generate competitive bids in hours rather than days — giving contractors who use them a significant advantage in winning work." },
          ],
          improving: [
            { title: "Robotic prefabrication", desc: "Factory robots cut, assemble, and finish wall panels, roof trusses, and modular components with precision, but on-site conditions — uneven foundations, out-of-square walls, unexpected obstacles — still require human carpenters to adapt and fit prefab elements." },
            { title: "Augmented reality layout and guidance", desc: "AR headsets overlay digital plans onto physical spaces, showing carpenters exactly where walls, outlets, and fixtures should go — but interpreting plans, solving conflicts, and making field adjustments remain human skills." },
          ],
          humanOnly: [
            { title: "On-site construction and installation", desc: "Framing walls, installing cabinets, hanging doors, running trim, and building stairs in real-world conditions — where nothing is perfectly square, level, or plumb — requires human dexterity, spatial reasoning, and decades of craft knowledge." },
            { title: "Custom and finish carpentry", desc: "Building custom cabinetry, fitting complex trim profiles, crafting built-ins, and executing high-end finish work demands an artisan's eye, hand skills, and aesthetic judgment that no machine can replicate." },
            { title: "Field problem-solving and adaptation", desc: "When the blueprint doesn't match the building, the lumber is warped, or the client changes their mind mid-project — the carpenter who can adapt, improvise, and solve problems on the fly is performing irreplaceable human work." },
          ]
        },
        tools: [
          { name: "PlanSwift", url: "https://www.planswift.com", desc: "AI-powered takeoff and estimating software that calculates materials, labor, and costs directly from digital blueprints. Mastering digital estimating is the business skill that separates top contractors from the rest." },
          { name: "Procore", url: "https://www.procore.com", desc: "Construction project management platform with AI-powered scheduling, document control, and quality tracking. The industry-standard tool for managing projects efficiently from bid to closeout." },
          { name: "Autodesk Construction Cloud", url: "https://construction.autodesk.com", desc: "BIM and construction management platform that connects 3D models to field work. Understanding BIM workflows gives carpenters an edge in coordination and prefabrication projects." },
        ],
        skills: [
          { text: "Use digital estimating and takeoff tools to produce faster, more accurate bids that win more work", tool: "PlanSwift" },
          { text: "Manage projects with construction management software for scheduling, documentation, and client communication", tool: "Procore" },
          { text: "Read and work from BIM models and digital construction plans, not just paper blueprints", tool: "Autodesk Construction Cloud" },
          { text: "Develop expertise across rough and finish carpentry to maximize career flexibility and earning potential" },
          { text: "Pursue journeyman and master carpenter credentials — the highest-value path in the trade for both employment and independent contracting" },
        ],
        faq: [
          { q: "Will robots replace carpenters?", a: "No — and it's not even close. Construction sites are chaotic, unpredictable environments where every building is different. Robotic prefabrication handles some factory work, but on-site carpentry — framing in the rain, fitting trim in a 100-year-old house, building custom features — requires human adaptability and craft skill. The skilled trades shortage means demand for carpenters is growing, not shrinking." },
          { q: "Is carpentry a good career in the AI era?", a: "One of the safest. The work can't be automated, offshored, or done remotely. The average carpenter is over 50, retirements are accelerating, and there aren't enough apprentices to fill the gap. Wages are rising — experienced carpenters earn $65-90K+ and contractors who run their own business earn significantly more. It's a career AI is making more valuable, not less." },
          { q: "How is technology changing carpentry?", a: "AI helps with estimating, project management, and design — making the business side more efficient. Laser levels, digital measuring tools, and AR layout systems make the craft more precise. Prefabrication is growing for repetitive components. But the core skill — building things with your hands in real-world conditions — remains unchanged and in massive demand." },
        ],
        resources: [
          ...
          { title: "NAHB — National Association of Home Builders", url: "https://www.nahb.org" },
          { title: "Fine Homebuilding — Craft Resources", url: "https://www.finehomebuilding.com" },
          { title: "JLC — Journal of Light Construction", url: "https://www.jlconline.com" },
        ],
        related: ["electrician", "plumber", "construction-pm"]
      },
    ]
  },
  {
  ...
  },
  {
    ...
    jobs: [
      ...
      { id: "chef", title: "Chef / Head Cook", risk: 12, augment: 52,
        summary: "No — cooking is a deeply physical, creative, and sensory profession that AI cannot replicate. AI optimizes kitchen operations, manages food costs, and automates ordering, but the creative vision, palate development, team leadership, and plate-level execution that define a chef remain fundamentally human.",
        keyInsight: "Robot kitchens exist for burgers and bowls, but they produce food, not cuisine. The restaurants people remember — and pay premiums for — are defined by a chef's creative vision, ingredient sourcing, and the controlled chaos of a professional kitchen.",
        aiChanging: "AI-powered kitchen management systems optimize inventory, predict demand, reduce food waste by 30-40%, and automate supplier ordering. Recipe costing tools calculate margins instantly. But creating a new dish, tasting for seasoning, training a line cook, and executing service under pressure remain human domains.",
        blsStats: { medianSalary: "$56,520", totalJobs: "158,200", growth: "+5%", growthLabel: "Growing" },
        aiCapability: {
          mastered: [
            { title: "Inventory management and food cost optimization", desc: "AI tracks ingredient usage in real time, predicts demand based on historical data and weather, auto-generates purchase orders, and flags food cost overruns — replacing the spreadsheet-and-clipboard systems chefs used to manage manually." },
            { title: "Demand forecasting and waste reduction", desc: "AI models predict covers by day, meal period, and even menu item, reducing overproduction and food waste by 30-40% — a massive improvement in both profitability and sustainability." },
          ],
          improving: [
            { title: "Recipe development and flavor pairing", desc: "AI suggests novel ingredient combinations based on molecular compound analysis and generates recipe variations, but the leap from interesting combination to extraordinary dish — balancing flavors, textures, and emotional impact — requires a chef's trained palate and creative instinct." },
            { title: "Automated cooking for simple items", desc: "Robotic kitchen systems can grill burgers, assemble bowls, and fry items with consistency, but they handle only standardized, simple preparations — not the precise, multi-technique cooking that defines restaurant-quality cuisine." },
          ],
          humanOnly: [
            { title: "Menu creation and culinary vision", desc: "Designing a menu that tells a story, reflects seasonal ingredients, balances flavors across courses, and creates an identity for a restaurant requires the creative vision, cultural knowledge, and artistic instinct that only a chef possesses." },
            { title: "Palate and sensory quality control", desc: "Tasting every sauce, adjusting seasoning on the fly, evaluating texture and temperature, and maintaining quality across hundreds of plates per service requires the trained human senses that define culinary excellence." },
            { title: "Kitchen leadership and team development", desc: "Running a kitchen brigade under intense time pressure — calling orders, managing stations, training cooks, handling the emotional intensity of service — is human leadership in its most demanding form." },
          ]
        },
        tools: [
          { name: "MarketMan", url: "https://www.marketman.com", desc: "AI-powered restaurant inventory and food cost management platform that automates purchasing, tracks waste, and provides real-time cost analysis. Mastering food cost technology is essential for the business side of being a chef." },
          { name: "BlueCart", url: "https://www.bluecart.com", desc: "AI-driven procurement platform that connects restaurants with suppliers, automates ordering based on par levels and demand forecasts, and compares vendor pricing to reduce food costs." },
          { name: "Apicbase", url: "https://www.apicbase.com", desc: "Kitchen management platform with AI-powered menu engineering, recipe costing, and food waste tracking. Use it to optimize your menu for both culinary quality and profitability." },
        ],
        skills: [
          { text: "Use AI inventory and procurement tools to reduce food costs and waste while maintaining ingredient quality", tool: "MarketMan" },
          { text: "Automate supplier ordering and price comparison to optimize purchasing without sacrificing sourcing standards", tool: "BlueCart" },
          { text: "Apply menu engineering analytics to balance creativity with profitability — knowing which dishes drive margin and which drive traffic", tool: "Apicbase" },
          { text: "Develop a distinctive culinary point of view that defines your restaurant's identity — the creative work AI cannot do" },
          { text: "Build kitchen leadership skills that develop talent, maintain standards under pressure, and create a culture of excellence" },
        ],
        faq: [
          { q: "Will robots replace chefs?", a: "For fast food and highly standardized preparations, robotic kitchens are making inroads. But for restaurants where the food is the experience — from neighborhood bistros to fine dining — the chef is irreplaceable. Cooking at a high level requires trained senses, creative judgment, and split-second decision-making under pressure that robots can't replicate. AI is a powerful back-office tool for chefs, not a replacement." },
          { q: "Is being a chef a good career in the AI era?", a: "Yes — restaurant dining continues to grow, and the demand for talented chefs exceeds supply. BLS projects 5% growth. The career path now includes mastering kitchen technology alongside culinary skills. Chefs who combine creative talent with business acumen and AI-powered operations management are the most valuable in the industry." },
          { q: "How is AI changing restaurant kitchens?", a: "AI handles the business operations behind the scenes — inventory tracking, demand forecasting, food cost optimization, and supplier management. Some chains are testing robotic cooking for simple items. But the creative and leadership core of the chef role is unchanged. The best chefs use AI to run leaner operations while focusing their energy on food quality and team development." },
        ],
        resources: [
          ...
          { title: "Nation's Restaurant News — Technology", url: "https://www.nrn.com" },
          { title: "Eater — Restaurant Industry Coverage", url: "https://www.eater.com" },
        ],
        related: ["server", "fast-food-worker", "hotel-manager"]
      },
    ]
  },
  {
