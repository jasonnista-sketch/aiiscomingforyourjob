export const INDUSTRIES = [
  {
    ...
    jobs: [
      { id: "physician", title: "Physician / Doctor", risk: 32, augment: 89,
        ...
        canDo: [
          "Analyze medical images for anomalies faster than humans",
          "Generate differential diagnoses from patient symptoms",
          "Monitor patient vitals and predict deterioration",
          "Automate clinical documentation and note-taking",
          "Cross-reference drug interactions across databases",
        ],
        cantDo: [
          "Build patient trust and deliver empathetic care",
          "Make complex ethical decisions about treatment",
          "Perform physical examinations and procedures",
          "Navigate nuanced family and end-of-life conversations",
          "Adapt to unexpected complications in real-time",
        ],
    ...
    jobs: [
      { id: "graphic-designer", title: "Graphic Designer", risk: 48, augment: 92,
        ...
        canDo: [
          ...
          "Create social media graphics from text prompts",
          "Remove backgrounds and edit images automatically",
          "Generate multiple logo variations quickly",
          "Auto-layout designs and resize for different formats",
        ],
        cantDo: [
          "Develop a cohesive brand identity with strategic intent",
          "Understand the emotional impact of design choices on audiences",
          "Navigate client feedback and creative direction",
          "Ensure design consistency across complex brand systems",
          "Make judgment calls about cultural sensitivity and context",
        ],
    ...
    jobs: [
      { id: "software-engineer", title: "Software Engineer", risk: 28, augment: 96,
        ...
        canDo: [
          ...
          "Auto-complete functions and suggest implementations",
          "Write unit tests from existing code",
          "Detect bugs and suggest fixes during code review",
          "Translate code between programming languages",
        ],
        cantDo: [
          "Architect complex distributed systems",
          "Understand business requirements and tradeoffs",
          "Debug novel production issues under pressure",
          "Make design decisions balancing tech debt vs. speed",
          "Navigate team dynamics and cross-functional collaboration",
        ],
